...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    if (localSettings.notificationSounds.custom) {
      const newAudio = new Audio(localSettings.notificationSounds.custom);
  ...
  const handleCustomSoundUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (localSettings.notificationSounds.custom && localSettings.notificationSounds.custom.startsWith('blob:')) {
        URL.revokeObjectURL(localSettings.notificationSounds.custom);
      }
  ...
  const handleRemoveCustomSound = () => {
    ...
    handleNotificationSoundChange('custom', null);
                ...
                <div className="flex items-center space-x-6">
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={() => handleNotificationSoundChange('default', true)}
                      className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                    />
                    <label htmlFor="defaultSound" className="ml-2 block text-sm font-medium text-gray-700">
                      Default
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      type="radio"
                      checked={!localSettings.notificationSounds.default}
                      onChange={() => handleNotificationSoundChange('default', false)}
                      disabled={!localSettings.notificationSounds.custom}
                      className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                    />
                    <label htmlFor="customSound" className="ml-2 block text-sm font-medium text-gray-700 ui-disabled:text-gray-400">
                      Custom
                    </label>
                  </div>
                </div>
